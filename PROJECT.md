...
- Git: main, origin은 personal-ai-workflow. 현재 이력의 머지 방식은 merge commit. 정책 변경 지시가 없으면 이를 따른다. PR 머지 후 해당 작업 head의 로컬·원격 정리까지 완료 조건으로 삼는다. 이전 초기 push 승인을 무관한 외부 행동 권한으로 확대하지 않음.
